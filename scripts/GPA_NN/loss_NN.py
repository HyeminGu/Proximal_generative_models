...
def f_Lip_divergence(P, Q, params={'f':'KL', 'L':1.0, 'alpha':None}, track_loss=False):
    # P, Q: numpy arrays
    ...
    lr_phi, epochs_phi, optimizer = 0.01, 3000, 'adam'
    ...
    if calc_Wasserstein1 == True:
        ...
        parameters, current_loss, dW_norm, track_losses = train_disc(parameters, phi, P, Q, lr_phi, epochs_phi, loss_par, NN_par, data_par, optimizer, print_vals=True, track_loss=True)
        
    if track_loss == True:
        return current_loss, track_losses
    else:
        return current_loss
