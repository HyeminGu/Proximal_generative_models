...
def plot4(net, x, y, tspan, nt_val, sPath, sTitle="", doPaths=False):
    """
    ...
    fx = integrate(x[:, 0:d], net, [tspan[0], tspan[1]], nt_val, stepper="rk4", alph=net.alph)
    finvfx = integrate(fx[:, 0:d], net, [tspan[1], tspan[0]], nt_val, stepper="rk4", alph=net.alph)
    genModel = integrate(y[:, 0:d], net, [tspan[1], tspan[0]], nt_val, stepper="rk4", alph=net.alph)
    ...
    # plot paths
    if doPaths:
        forwPath = integrate(x[:, 0:d], net, [tspan[0], tspan[1]], nt_val,  stepper="rk4", alph=net.alph, intermediates=True)
        backPath = integrate(fx[:, 0:d], net, [tspan[1], tspan[0]], nt_val, stepper="rk4", alph=net.alph, intermediates=True)
